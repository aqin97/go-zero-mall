...
type OrderClient interface {
	...
	Update(ctx context.Context, in *UpdateRequset, opts ...grpc.CallOption) (*UpdateResponse, error)
...
func (c *orderClient) Update(ctx context.Context, in *UpdateRequset, opts ...grpc.CallOption) (*UpdateResponse, error) {
...
type OrderServer interface {
	...
	Update(context.Context, *UpdateRequset) (*UpdateResponse, error)
...
func (UnimplementedOrderServer) Update(context.Context, *UpdateRequset) (*UpdateResponse, error) {
...
func _Order_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).Update(ctx, req.(*UpdateRequset))
	}
	return interceptor(ctx, in, info, handler)
}
