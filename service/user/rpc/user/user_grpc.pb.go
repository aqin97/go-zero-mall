...
func (c *userClient) Login(ctx context.Context, in *LoginRequset, opts ...grpc.CallOption) (*LoginResponse, error) {
...
func (UnimplementedUserServer) Login(context.Context, *LoginRequset) (*LoginResponse, error) {
...
func _User_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).Login(ctx, req.(*LoginRequset))
	}
